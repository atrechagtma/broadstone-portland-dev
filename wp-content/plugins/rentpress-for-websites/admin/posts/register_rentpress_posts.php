      ...
      switch ($data_type) {
        ...
        case 'neighborhood':
          ...
          if($hoodID) {
            ...
            if ($link) {
              $columnHTML ='<a href="'. esc_url($link) .'">'. wp_kses($columnHTML, $rentpress_allowed_HTML) .'</a>';
            }
            echo wp_kses($columnHTML, $rentpress_allowed_HTML);
          }
          // case end
          break;
        ...
        case 'term':
          ...
          case 'availability':
            // case start
              $units = isset($thisMeta[$meta_key][0]) ? $thisMeta[$meta_key][0] : '';
              if ($units) {
