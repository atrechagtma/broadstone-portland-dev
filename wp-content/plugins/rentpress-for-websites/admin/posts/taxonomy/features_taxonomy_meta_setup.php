...
function rentpress_edit_feature_meta($term) {
  ...
  <div class="rentpress-cpt-editor-container">
        ...
        <div class="rentpress-tabs">
            <div class="rentpress-tab-button" onclick="openTab(event, 'feature-marketing')"><i class="fas fa-bullhorn"></i> Marketing</div>
            <div class="rentpress-tab-button" onclick="openTab(event, 'feature-info')"><i class="fas fa-info-circle"></i> Info</div>
        ...
        <div id="feature-marketing" class="rentpress-tab-section">
            ...
            <div class="rentpress-panel">
                <p class="rentpress-panel-heading">Add an image to represent this feature. For best results, use an image with landscape orientation and at least 1000px on the shortest side.</p>
            ...
            <div class="rentpress-panel">
                <p class="rentpress-panel-heading">Add a short summary description about this feature. This description will also be used on property pages. For best results, keep less than 120 characters.</p>

                <div class="rentpress-settings-group">
                    <label class="rentpress-settings-title">Short Description</label>
                    <?php echo wp_kses(rentpress_metaShadowField('rentpress_custom_field_feature_short_description', $rpd, 'text', '', 'description'), $rentpress_allowed_HTML); ?>
                </div>
            </div>
            <!-- tab accordion end -->
...
function rentpress_save_feature_meta( $term_id ) {
    $termFields = [
        'rentpress_custom_field_feature_name',
        'rentpress_custom_field_feature_slug',
        'rentpress_custom_field_feature_descrition',
    ];
    $args = array();
