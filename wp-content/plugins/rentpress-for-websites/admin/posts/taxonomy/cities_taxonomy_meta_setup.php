...
<div class="rentpress-cpt-editor-container">
  ...
  <div class="rentpress-tabs">
    <div class="rentpress-tab-button" onclick="openTab(event, 'city-marketing')"><span class="fas fa-bullhorn"
        aria-hidden="true"></span> Marketing</div>
    <div class="rentpress-tab-button" onclick="openTab(event, 'city-info')"><span class="fas fa-info-circle"
  ...
  <div id="city-marketing" class="rentpress-tab-section">
    ...
    <div class="rentpress-panel">
      <p class="rentpress-panel-heading">Add an image to represent this city. For best results, use an image with
    ...
    <div class="rentpress-panel">
      <p class="rentpress-panel-heading">Add a short summary description about this city. This description will also be
