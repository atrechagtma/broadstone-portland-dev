...
function rentpress_edit_city_meta($term) {
  ...
  <div class="rentpress-cpt-editor-container">
        ...
        <div class="rentpress-tabs">
            <div class="rentpress-tab-button" onclick="openTab(event, 'city-marketing')"><i class="fas fa-bullhorn"></i> Marketing</div>
            <div class="rentpress-tab-button" onclick="openTab(event, 'city-info')"><i class="fas fa-info-circle"></i> Info</div>
            <div id="rentpress-expand-all">Expand All</div>
        </div>

        <!-- tab start -->
        <div id="city-marketing" class="rentpress-tab-section">
            
            <!-- tab accordion start -->
            <div class="rentpress-accordion"><i class="fas fa-images"></i> Featured Image</div>
            <div class="rentpress-panel">
                <p class="rentpress-panel-heading">Add an image to represent this city. For best results, use an image with landscape orientation and at least 1000px on the shortest side.</p>

                <div class="rentpress-settings-group">
                    <label class="rentpress-settings-title">Featured Image</label>
                    <?php echo wp_kses(rentpress_metaFieldImage('rentpress_custom_field_city_image', $rpm, 'text', '', 'true'), $rentpress_allowed_HTML); ?>
                </div>
            </div>
            <!-- tab accordion end -->
            ...
            <div class="rentpress-panel">
                <p class="rentpress-panel-heading">Add a short summary description about this city. This description will also be used on property pages. For best results, keep less than 120 characters.</p>
            ...
            <div class="rentpress-panel">
                <p class="rentpress-panel-heading">Add in more content or information about the city.</p>

                <div class="rentpress-settings-group">
                    <label class="rentpress-settings-title">Extended Content</label>
                    <?php echo wp_kses(rentpress_metaTextArea('rentpress_custom_field_city_extended_content', $rpm, '25'), $rentpress_allowed_HTML); ?>
                </div>
            </div>
            <!-- tab accordion end -->
            ...
            <div class="rentpress-panel">
                ...
                <div class="rentpress-settings-group">
                    ...
                    <?php echo wp_kses(rentpress_metaField('rentpress_custom_field_city_shortcode', $rpm, 'text'), $rentpress_allowed_HTML); ?>
                </div>
            </div>
            <!-- tab accordion end -->
        ...
        <!-- tab start -->
        <div id="city-info" class="rentpress-tab-section">
            ...
            <div class="rentpress-panel">
                ...
                <div class="rentpress-settings-group">
                    ...
                    <?php echo wp_kses(rentpress_metaShadowField('rentpress_custom_field_city_name', $rpd, 'text', '', 'name'), $rentpress_allowed_HTML); ?>
                </div>
           ...
           <!--  <div class="rentpress-accordion"><i class="fas fa-tags"></i> Properties</div>
            <div class="rentpress-panel">
                ...
                <div class="rentpress-settings-group">
                    Properties
                    <?php // echo rentpress_metaField('rentpress_custom_field_city_special_text', $rpm, 'text'); ?>
                </div>
            </div> -->
            <!-- tab accordion end -->
