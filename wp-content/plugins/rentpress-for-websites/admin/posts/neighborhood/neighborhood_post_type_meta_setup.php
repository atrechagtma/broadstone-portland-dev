...
?>
    <div class="rentpress-cpt-editor-container">
        <div class="rentpress-tabs">
            <div class="rentpress-tab-button" onclick="openTab(event, 'neighborhood-properties')"><i class="fas fa-list"></i> Properties</div>
            <div class="rentpress-tab-button" onclick="openTab(event, 'neighborhood-info')"><i class="fas fa-info-circle"></i> Info</div>
        ...
        <div id="neighborhood-properties" class="rentpress-tab-section">
            <div class="rentpress-accordion"><i class="fas fa-list"></i> Properties</div>
        ...
        <div id="neighborhood-info" class="rentpress-tab-section">
            <div class="rentpress-accordion"><i class="fas fa-info-circle"></i> Info</div>
            <div class="rentpress-panel">
                <p>Add romance copy about this neighborhood. This copy will be used on the neighborhood and property page templates.</p>
        ...
        <!-- <div id="neighborhood-location" class="rentpress-tab-section">
            <div class="rentpress-accordion"><i class="fas fa-map-marker-alt"></i> Location</div>
            <div class="rentpress-panel">
