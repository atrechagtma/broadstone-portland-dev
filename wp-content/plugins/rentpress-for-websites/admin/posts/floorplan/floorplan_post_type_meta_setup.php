...
function rentpress_custom_floorplan_data_box_html($post)
{
    ...
    <div class="rentpress-cpt-editor-container">
        <div class="rentpress-tabs">
            <div class="rentpress-tab-button" onclick="openTab(event, 'fp-marketing')"><i class="fas fa-bullhorn"></i> Marketing</div>
            <div class="rentpress-tab-button" onclick="openTab(event, 'fp-info')"><i class="fas fa-info-circle"></i> Info</div>
            <div class="rentpress-tab-button" onclick="openTab(event, 'fp-units')"><i class="fas fa-cube"></i> Units</div>
        ...
        <div id="fp-marketing" class="rentpress-tab-section">
            ...
            <div class="rentpress-panel">
                <p class="rentpress-panel-heading">Add the current special for this floor plan. You can also add a link destination and/or an expiration date.</p>
            ...
            <div class="rentpress-accordion"><i class="far fa-play-circle"></i> Virtual Tour</div>
            <div class="rentpress-panel">
            ...
            <div class="rentpress-accordion"><i class="far fa-images"></i> Images</div>
           <!--  <div class="rentpress-panel">
            ...
            <div class="rentpress-accordion"><i class="fas fa-align-left"></i> Narrative Description</div>
            <div class="rentpress-panel">
        ...
        <div id="fp-info" class="rentpress-tab-section">
            <div class="rentpress-accordion"><i class="fas fa-info-circle"></i> Floor Plan Info</div>
            <div class="rentpress-panel">
            ...
            <div class="rentpress-panel">
                <p>Values are calculated based on the "Price Ranges" RentPress setting. You can select which you would like to display or optionally override each value.</p>
        ...
        <div id="fp-units" class="rentpress-tab-section">
            <div class="rentpress-accordion"><i class="fas fa-chart-bar"></i> Unit Stats</div>
            <div class="rentpress-panel">
                <p class="rentpress-override-bottom">Note that the unit stats shown here are calculated from the units for this floor plan.</p>
                <div>
                    <div class="rentpress-settings-group">
                        <div class="rentpress-settings-title-alt"></div>
                        <div><?php echo $floorplan->floorplan_available ? 'Floorplan is available' : 'Floorplan is not available' ?></div>
                    </div>

                    <div class="rentpress-settings-group">
                        <div class="rentpress-settings-title-alt">Total Units</div>
                        <div><?php echo esc_html($floorplan->floorplan_units_total); ?></div>

                    </div>

                    <div class="rentpress-settings-group">
                        <div class="rentpress-settings-title-alt">Available Based on settings</div>
                        <div><?php echo esc_html($floorplan->floorplan_units_available); ?></div>

                    </div>

                    <div class="rentpress-settings-group">
                        <div class="rentpress-settings-title-alt">Available in 30 days </div>
                        <div><?php echo esc_html($floorplan->floorplan_units_available_30); ?></div>

                    </div>

                    <div class="rentpress-settings-group">
                        <div class="rentpress-settings-title-alt">Available in 60 days</div>
                        <div><?php echo esc_html($floorplan->floorplan_units_available_60); ?></div>
                    ...
                    <div class="rentpress-settings-group">
                        ...
                        <div>
                            <?php echo esc_html($floorplan->floorplan_units_unavailable); ?>
                        </div>
                    </div>
                </div>
            </div>

            <div class="rentpress-accordion"><i class="fas fa-plus-square"></i> Add New Unit</div>
            <div class="rentpress-panel">
                <h3 id="results_for_new_unit" class="rentpress-request-results"></h3>
                <p class="rentpress-panel-heading">To add a unit to this floor plan, fill out the form with the required information. Most values are pre-populated based on this floor plan's information.</p>
                <div id="rentpress-new-unit-form">
                    <input class="rentpress-new-unit-form-value" type="hidden" name="unit_parent_property_code" value = "<?php echo esc_attr($floorplan->floorplan_parent_property_code); ?>" >
                    <input class="rentpress-new-unit-form-value" type="hidden" name="unit_parent_floorplan_code" value = "<?php echo esc_attr($floorplan->floorplan_code); ?>" >
                    <input class="rentpress-new-unit-form-value" type="hidden" name="unit_bedrooms" value="<?php echo esc_attr($floorplan->floorplan_bedrooms) ?>" >
                    <input class="rentpress-new-unit-form-value" type="hidden" name="unit_bathrooms" value="<?php echo esc_attr($floorplan->floorplan_bathrooms) ?>" >

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_code">Unit Code</label>
                        <input id="rentpress-unit-code" class="rentpress-settings-text rentpress-new-unit-form-value" type="text" name="unit_code">
                    </div>

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_name">Unit Name</label>
                        <input id="rentpress-unit-name" class="rentpress-settings-text rentpress-new-unit-form-value" type="text" name="unit_name">
                    </div>

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_sqft">SQ FT</label>
                        <input class="rentpress-settings-text rentpress-new-unit-form-value" type="number" name="unit_sqft" value="<?php echo esc_attr(!empty($floorplan->floorplan_sqft_max) ? $floorplan->floorplan_sqft_max : $floorplan->floorplan_sqft_min); ?>">
                    </div>

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_rent_min">Min Rent</label>
                        <input class="rentpress-settings-text rentpress-new-unit-form-value" type="number" name="unit_rent_min" value="<?php echo esc_attr($floorplan->floorplan_rent_min); ?>">
                    </div>

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_rent_max">Max Rent</label>
                        <input class="rentpress-settings-text rentpress-new-unit-form-value" type="number" name="unit_rent_max" value="<?php echo esc_attr($floorplan->floorplan_rent_max); ?>">
                    </div>

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_rent_base">Base Rent</label>
                        <input class="rentpress-settings-text rentpress-new-unit-form-value" type="number" name="unit_rent_base" value="<?php echo esc_attr($floorplan->floorplan_rent_base); ?>">
                    </div>

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_rent_market">Market Rent</label>
                        <input class="rentpress-settings-text rentpress-new-unit-form-value" type="number" name="unit_rent_market" value="<?php echo esc_attr($floorplan->floorplan_rent_market); ?>">
                    </div>

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_rent_term_best">Best Term Rent</label>
                        <input class="rentpress-settings-text rentpress-new-unit-form-value" type="number" name="unit_rent_term_best" value="<?php echo esc_attr($floorplan->floorplan_rent_term) ?>">
                    </div>

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_rent_effective">Effective Rent</label>
                        <input class="rentpress-settings-text rentpress-new-unit-form-value" type="number" name="unit_rent_effective" value="<?php echo esc_attr($floorplan->floorplan_rent_effective); ?>">
                    </div>
                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_rent_best">Best Rent</label>
                        <input class="rentpress-settings-text rentpress-new-unit-form-value" type="number" name="unit_rent_best" value="<?php echo esc_attr($floorplan->floorplan_rent_best); ?>">
                    </div>

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_ready_date">Soonest Available Date </label>
                        <input id="rentpress-unit-ready-date" class="rentpress-settings-text rentpress-new-unit-form-value" type="date" name="unit_ready_date">
                    </div>

                    <div class="rentpress-settings-group">
                        <label class="rentpress-settings-title" for="unit_availability_url">Unit Application URL </label>
                        <input id="unit_availability_url" class="rentpress-settings-text rentpress-new-unit-form-value" type="url" name="unit_availability_url">
                    </div>

                    <div class="rentpress-button-container">
                        <div id="rentpress-new-unit-button" class="rentpress-action-button rentpress-action-button-active"><i class="far fa-plus-square"></i> Add Unit</div>
                    </div>
                </div>

            </div>

            <div class="rentpress-accordion"><i class="fas fa-cube"></i> Manage Units</div>
            <div class="rentpress-panel">
    ...
    <div id="rentpress-edit-unit-form-container" class="rentpress-admin-modal" onclick="closeEditUnitModal()">
        ...
        <div onclick="event.stopPropagation()" class="rentpress-modal-form-container">
            ...
            <div id="rentpress-edit-unit-form" class="rentpress-modal-form">
                ...
                <h1 class="rentpress-edit-unit-title ">Unit <input id="rentpress-edit-unit-code" class="rentpress-edit-unit-form-value" name="unit_edit_code" disabled></h1>

                <input class="rentpress-edit-unit-form-value" type="hidden" name="unit_edit_parent_property_code" value="<?php echo esc_attr($floorplan->floorplan_parent_property_code); ?>" >
                <input class="rentpress-edit-unit-form-value" type="hidden" name="unit_edit_parent_floorplan_code" value="<?php echo esc_attr($floorplan->floorplan_code); ?>" >
                <input class="rentpress-edit-unit-form-value" type="hidden" name="unit_edit_bedrooms" value="<?php echo esc_attr($floorplan->floorplan_bedrooms); ?>" >
                <input class="rentpress-edit-unit-form-value" type="hidden" name="unit_edit_bathrooms" value="<?php echo esc_attr($floorplan->floorplan_bathrooms); ?>" >

                <div class="rentpress-settings-group">
                    <label class="rentpress-settings-title" for="unit_edit_name">Name</label>
                    <input id="rentpress-edit-unit-name" class="rentpress-settings-text rentpress-edit-unit-form-value" name="unit_edit_name">
                </div>
                ...
                <div class="rentpress-settings-group">
                    <label class="rentpress-settings-title">Market Rent</label>
                    <input type="number" name="unit_edit_rent_market" class="rentpress-settings-text rentpress-edit-unit-form-value">
                </div>

                <div class="rentpress-settings-group">
                    <label class="rentpress-settings-title">Best Term Rent</label>
                    <input type="number" name="unit_edit_rent_term_best" class="rentpress-settings-text rentpress-edit-unit-form-value">
                </div>

                <div class="rentpress-settings-group">
                    <label class="rentpress-settings-title">Effective Rent</label>
                    <input type="number" name="unit_edit_rent_effective" class="rentpress-settings-text rentpress-edit-unit-form-value">
                </div>
                ...
                <div class="rentpress-settings-group">
                    ...
                    <input id="rentpress-edit-unit-ready-date" class="rentpress-settings-text rentpress-edit-unit-form-value" type="date" name="unit_edit_ready_date">
                </div>


                <div class="rentpress-settings-group">
                    <label class="rentpress-settings-title" for="unit_edit_availability_url">Unit Application URL </label>
                    <input class="rentpress-settings-text rentpress-edit-unit-form-value" type="url" name="unit_edit_availability_url">
                </div>

                <div id="rentpress-edit-unit-button-container" class="rentpress-button-container">
                    <div id="rentpress-save-unit-button" class="rentpress-action-button rentpress-action-button-active"><i class="far fa-share-square"></i> Update Unit</div>

                    <div id="rentpress-delete-unit-button" class="rentpress-action-button rentpress-delete-button" onclick="showDeleteConfirmation()"><i class="far fa-trash-alt"></i> Delete Unit</div>
                </div>
                ...
                <div id="rentpress-delete-confirmation-container" class="rentpress-button-container">
                    ...
                    <div id="rentpress-cancel-unit-button" class="rentpress-action-button rentpress-cancel-button" onclick="hideDeleteConfirmation()"><i class="fas fa-exclamation-triangle"></i> Cancel</div>

                    <div id="rentpress-permanent-delete-unit-button" class="rentpress-action-button rentpress-delete-button"><i class="far fa-trash-alt"></i> Delete Unit</div>
                </div>
