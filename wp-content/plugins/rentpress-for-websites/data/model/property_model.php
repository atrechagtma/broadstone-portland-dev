...
function rentpress_standardizePropertyFeedData($property)
{
    return [
        ...
        'property_features' => isset($property->Features) ? json_encode($property->Features) : null,
...
function rentpress_makePropertyDBTable()
{
    ...
    $sql = "CREATE TABLE $table_name (
        ...
        property_primary_neighborhood_post_id longtext,
        property_neighborhood_post_ids longtext,
        property_neighborhood_post_names longtext,
		property_neighborhood_post_name longtext,
		property_staff longtext,
		property_images longtext,
        property_accent_color longtext,
        property_use_accent_color int,
        ...
        property_add_on_fields longtext,
