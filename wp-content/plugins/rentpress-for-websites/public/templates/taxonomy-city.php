<?php
/**
 * Template Name: RentPress City Term
 *
...
<main class="main-content" role="main">
		<div class="rentpress-page-hero">
			<header class="rentpress-page-hero-full">
				<h1 class="rentpress-page-title"><?php echo 'Apartments In <br />'. esc_html(get_queried_object()->name); ?></h1>
				<img src="<?php echo esc_url(isset($featured_image) ? $featured_image : $city_image); ?>" class="lazyload">
			</header>
		</div>
